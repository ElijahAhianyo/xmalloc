...
I wrote this primarily to experiment an `sbrk` based malloc vs an `mmap` based malloc in assembly.
The core logic is written in assembly and the glue code to test this is written in c.
